# How to Modify Existing Annotations in PDF using JavaScript

This project is a complete working application to modify the existing annotations in PDF using JavaScript.

## Getting Started

To get started you need to clone the `pdf-modify-annotations` repository.
