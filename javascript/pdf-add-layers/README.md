# How to Add Layers in a PDF File Using JavaScript

This project is a complete working application to add layers in a PDF file using JavaScript.

## Getting Started

To get started you need to clone the `pdf-add-layers` repository.
