# How to Remove a Bookmark from PDF (By Index) Using JavaScript

This project is a complete working application to remove a bookmark from PDF by index using JavaScript.

## Getting Started

To get started you need to clone the `pdf-remove-bookmark` repository.
