# How to Add Headers and Footers in PDF in JavaScript

This project is a complete working application to add headers and footers in PDF document using JavaScript.

## Getting Started

To get started you need to clone the `pdf-header-footer` repository.
