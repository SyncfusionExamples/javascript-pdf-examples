# How to Remove Annotations from a PDF in JavaScript

This project is a complete working application to remove annotation from PDF using JavaScript.

## Getting Started

To get started you need to clone the `pdf-remove-annotations` repository.
