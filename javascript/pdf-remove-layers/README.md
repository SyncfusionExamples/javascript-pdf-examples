# How to Remove Layers from a PDF File Using JavaScript

This project is a complete working application to remove layers from a PDF file using JavaScript.

## Getting Started

To get started you need to clone the `pdf-remove-layers` repository.
