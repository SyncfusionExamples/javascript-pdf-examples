# How to Create a Custom Stamp Annotation in PDF in JavaScript

This project is a complete working application to create a custom stamp annotation in PDF using JavaScript.

## Getting Started

To get started you need to clone the `pdf-stamp-annotations` repository.
