# How to Merge Multiple PDFs into One File in JavaScript

This project is a complete working application to merge multiple PDFs into one file using JavaScript.

## Getting Started

To get started you need to clone the `pdf-merge-sample` repository.
