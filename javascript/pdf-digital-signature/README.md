# How to Digitally Sign a PDF file in JavaScript

This project is a complete working application to digitally sign a PDF file using JavaScript.

## Getting Started

To get started you need to clone the `pdf-digital-signature` repository.
