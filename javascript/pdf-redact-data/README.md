# How to Redact Data from PDF document in JavaScript

This project is a complete working application to redact data from PDF document using JavaScript.

## Getting Started

To get started you need to clone the `pdf-redact-data` repository.
