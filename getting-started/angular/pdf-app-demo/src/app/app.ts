...
import {
  PdfDocument, PdfPageSettings, PdfMargins,
  PdfPage, PdfGraphics, PdfBrush, PdfPen, PdfFont,
...
export class App {
  ...
  */
  createPdf(): void {
    ...
    graphics.drawString('Reporting Solutions', subHeadingFont,
    ...
    yPos = this.drawHeaderPoint(graphics,
    ...
    yPos = this.drawBodyContent(graphics,
    ...
    graphics.drawLine(redPen, { x: headerX, y: yPos + 92 }, { x: headerX, y: yPos + 145 });
    ...
    graphics.drawLine(greenPen, { x: headerX, y: yPos + 32 }, { x: headerX, y: yPos + 85 });
    graphics.drawString('Product Licensing', titleFont,
      { x: headerX + 10, y: yPos + 30, width: 250, height: 200 }, black);
    graphics.drawLine(bluePen,
      { x: headerX + 280, y: yPos + 32 },
      { x: headerX + 280, y: yPos + 85 });
    graphics.drawString('About Syncfusion', titleFont,
    ...
    graphics.drawString(
      ...
      footerFont,
      { x: 10, y: graphics.clientSize.height - 30, width: 250, height: 200 },
      white
    );
    ...
    const annotation = new PdfTextWebLinkAnnotation(
