# How to Add and Remove Bookmarks to a PDF File in TypeScript

This project is a complete working application for adding and removing bookmarks to a PDF file using TypeScript.

## Getting Started

To get started you need to clone the `pdf-bookmark-sample` repository and navigate to `pdf-bookmark-sample` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-bookmark-sample
cd pdf-bookmark-sample
```
