# How to to Import Annotations into PDF using TypeScript

This project is a complete working application to import annotations into PDF in TypeScript.

## Getting Started

To get started you need to clone the `pdf-import-annotations` repository and navigate to `pdf-import-annotations` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-import-annotations
cd pdf-import-annotations
```
