...
To get started you need to clone the `pdf-text-flow` repository and navigate to `pdf-text-flow` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-text-flow
cd pdf-text-flow
```
