# How to Modify Existing Annotations in PDF using TypeScript

This project is a complete working application to modify the existing annotations in PDF TypeScript.

## Getting Started

To get started you need to clone the `pdf-modify-annotations` repository and navigate to `pdf-modify-annotations` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-modify-annotations
cd pdf-modify-annotations
```
