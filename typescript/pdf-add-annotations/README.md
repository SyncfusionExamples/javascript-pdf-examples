# How to Add Annotations in PDF in TypeScript

This project is a complete working application to add annotations in PDF using TypeScript.

## Getting Started

To get started you need to clone the `pdf-add-annotations` repository and navigate to `pdf-add-annotations` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-add-annotations
cd pdf-add-annotations
```
