# How to Merge Multiple PDFs into One File in TypeScript

This project is a complete working application to merge multiple PDFs into one file using TypeScript.

## Getting Started

To get started you need to clone the `pdf-merge-sample` repository and navigate to `pdf-merge-sample` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-merge-sample
cd pdf-merge-sample
```
