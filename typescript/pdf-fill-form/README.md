# How to Add Fillable Form Fields to a PDF Document in TypeScript

This project is a complete working application to add fillable form fields to a PDF document using TypeScript.

## Getting Started

To get started you need to clone the `pdf-form-fillings` repository and navigate to `pdf-form-fillings` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-form-fillings
cd pdf-form-fillings
```
