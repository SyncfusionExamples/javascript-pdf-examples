# How to Digitally Sign a PDF file in TypeScript

This project is a complete working application to digitally sign a PDF file using TypeScript.

## Getting Started

To get started you need to clone the `pdf-digital-signature` repository and navigate to `pdf-digital-signature` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-digital-signature
