# How to Add Headers and Footers in PDF in TypeScript

This project is a complete working application to add headers and footers in PDF document using TypeScript.

## Getting Started

To get started you need to clone the `pdf-header-footer` repository and navigate to `pdf-header-footer` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-header-footer
cd pdf-header-footer
```
