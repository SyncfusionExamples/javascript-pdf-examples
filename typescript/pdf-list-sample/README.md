# How to Add Ordered List and Unorder List in PDF document in TypeScript

This project is a complete working application to add ordered and unordered list in PDF document using TypeScript.

## Getting Started

To get started you need to clone the `pdf-list-sample` repository and navigate to `pdf-list-sample` location.
