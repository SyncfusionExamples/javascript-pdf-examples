# How to Add Layers to a PDF File in TypeScript

This project is a complete working application for adding layers to a PDF file using TypeScript.

## Getting Started

To get started you need to clone the `pdf-add-layers` repository and navigate to `pdf-add-layers` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-add-layers
cd pdf-add-layers
```
