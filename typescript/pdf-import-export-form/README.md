# How to Import and Export PDF Form Data (FDF, XFDF, JSON) in TypeScript

This project is a complete working application to import and export PDF form data (FDF, XFDF, JSON) using TypeScript.

## Getting Started

To get started you need to clone the `pdf-import-export-form` repository and navigate to `pdf-import-export-form` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-import-export-form
