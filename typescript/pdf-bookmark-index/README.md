# How to Get Bookmark Page Index from PDF in TypeScript

This project is a complete working application to get bookmark page index from PDF file using TypeScript.

## Getting Started

To get started you need to clone the `pdf-bookmark-index` repository and navigate to `pdf-bookmark-index` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-bookmark-index
cd pdf-bookmark-index
```
