# How to Remove Annotations from a PDF in TypeScript

This project is a complete working application to remove annotation from PDF using TypeScript.

## Getting Started

To get started you need to clone the `pdf-remove-annotations` repository and navigate to `pdf-remove-annotations` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-remove-annotations
cd pdf-remove-annotations
```
