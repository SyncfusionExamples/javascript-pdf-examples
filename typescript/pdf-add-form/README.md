# How to Add Form Fields to an Existing PDF in TypeScript

This project is a complete working application to add form fields to an fxisting PDF using TypeScript.

## Getting Started

To get started you need to clone the `pdf-add-form` repository and navigate to `pdf-add-form` location.

```
git clone https://github.com/SyncfusionExamples/javascript-pdf-examples.git pdf-add-form
cd pdf-add-form
```
